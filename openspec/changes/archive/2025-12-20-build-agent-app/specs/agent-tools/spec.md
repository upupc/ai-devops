...
Agent 工具是 AI Agent 与文件系统和终端交互的能力接口，包括文件读写和命令执行。
...
- 参见 [chat/spec.md](../chat/spec.md) - 工具调用结果显示在聊天界面
- 参见 [file-browser/spec.md](../file-browser/spec.md) - 文件操作后文件树同步
- 参见 [workspace/spec.md](../workspace/spec.md) - 工具在工作区目录中执行
