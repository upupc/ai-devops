...
聊天系统是 Agent 应用的核心交互模块，负责管理用户与 AI Agent 之间的多轮对话。
...
- 参见 [workspace/spec.md](../workspace/spec.md) - 工作区创建与会话关联
- 参见 [file-browser/spec.md](../file-browser/spec.md) - 工具调用后文件树更新
